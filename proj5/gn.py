...
def compute_score(all_nodes, root):
    ...
    if len(curr_child_edge)==0:
        ...
        return all_nodes[root]['node_score']
...
if __name__ == '__main__':
    ...
    for r in sorted(node_dict.keys()):
        result = graph(r)
        compute_score(result, r)
